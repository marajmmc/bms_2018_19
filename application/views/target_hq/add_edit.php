...
<div class="row widget">
    ...
    <div class="row show-grid">
        <div class="col-xs-4">
            <label class="control-label pull-right"><?php echo $CI->lang->line('LABEL_LOCATION'); ?> &nbsp;</label>
        </div>
        <div class="col-sm-4 col-xs-8">
            <label class="control-label"><?php echo Target_helper::get_location_name(); ?></label>
        </div>
    </div>
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        get_delete_history(); // First time Call, when Page Loads
        ...
        $(document).on("change", "#year, #month", function (event) {
            get_delete_history(); // Call, when Month/Year OnChange
        });
    });
