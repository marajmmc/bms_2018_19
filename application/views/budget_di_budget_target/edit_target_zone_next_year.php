                ...
                [
                    ...
                    foreach($fiscal_years_next_budgets as $fy)
                    {
                        ...
                        foreach($zones as $zone)
                        {
                            ++$zone_sl;
                            ?>
                            {columngroup: 'next_years_<?php echo $serial;?>', text: '<?php echo $zone_sl.'. '.$zone['zone_name']?>', datafield: 'quantity_prediction_zi_<?php echo $serial;?>_<?php echo $zone['zone_id']?>', width: 100, filterable: false, cellsalign: 'right',cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg,columntype: 'textbox',
