...
if((isset($CI->permissions['action1']) && ($CI->permissions['action1']==1))||(isset($CI->permissions['action2']) && ($CI->permissions['action2']==1)))
{
    ...
    (
        ...
        'data-action-link'=>site_url($CI->controller_url.'/index/assign_target_zi/'.$options['fiscal_year_id'].'/'.$options['division_id'])
...
(
    ...
    'href'=>site_url($CI->controller_url.'/index/list_target_zi/'.$options['fiscal_year_id'])
);
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_url.'/index/get_items_target_zi');?>";
