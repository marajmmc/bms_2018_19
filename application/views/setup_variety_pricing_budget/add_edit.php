...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on("click", "#button_action_save_jqx", function(event)
        {
            ...
            {
                $('#save_form_jqx  #jqx_inputs').append('<input type="hidden" name="items['+data[i]['variety_id']+']" value="'+data[i]['price']+'">');
            }
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { text: '<?php echo $CI->lang->line('LABEL_PRICE'); ?>',datafield: 'price', width: 100,filterable: false,cellsrenderer: cellsrenderer,cellsalign: 'right',columntype: 'custom',
