...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_url.'/index/get_items_edit_target_outlet');?>";
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { columngroup:'outlet_<?php echo $outlet['outlet_id']?>',text: 'Target',datafield: 'quantity_target_outlet_<?php echo $outlet['outlet_id']?>', width: 100,filterable: false, align: 'center',cellsalign: 'right',cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg,columntype: 'textbox',
