...
if((isset($CI->permissions['action1']) && ($CI->permissions['action1']==1))||(isset($CI->permissions['action2']) && ($CI->permissions['action2']==1)))
{
    ...
    (
        ...
        'data-action-link'=>site_url($CI->controller_url.'/index/edit_budget_zone/'.$options['fiscal_year_id'].'/'.$options['zone_id'])
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_url.'/index/get_items_budget_zone');?>";
