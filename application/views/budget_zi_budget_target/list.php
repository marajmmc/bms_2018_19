        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    { text: '(Outlet) <?php echo $CI->lang->line('LABEL_STATUS_TARGET_FORWARD'); ?>', dataField: 'status_target_forward', width:'150',filtertype: 'list'},
                    { text: '(Outlet NXT 3Y) <?php echo $CI->lang->line('LABEL_STATUS_TARGET_FORWARD'); ?>', dataField: 'status_target_next_year_forward', width:'150',filtertype: 'list'}
                ]
            });
    });
</script>
