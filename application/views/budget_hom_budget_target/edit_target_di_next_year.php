...
(
    ...
    'href'=>site_url($CI->controller_url.'/index/list_target_di_next_year/'.$options['fiscal_year_id'])
);
...
<div class="row widget">
    ...
    ?>
    <form id="save_form_jqx" action="<?php echo site_url($CI->controller_url.'/index/save_target_di_next_year');?>" method="post">
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_url.'/index/get_items_edit_target_di_next_year');?>";
        ...
        $("#system_jqx_container").jqxGrid(
            {
                ...
                [
                    ...
                    ?>
                    { text: 'Current Year<br> Target', dataField: 'quantity_target',width:'100',filterable:false, align: 'center',cellsalign: 'right',editable:false,cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg},
                    <?php
                    $serial=0;
                    foreach($fiscal_years_next_budgets as $fy)
                    {
                        ...
                        {columngroup: 'next_years_<?php echo $serial;?>', text: 'Prediction', datafield: 'quantity_prediction_<?php echo $serial;?>', width: 100, filterable: false, cellsalign: 'right',cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg,columntype: 'textbox',
                            ...
                            {columngroup: 'next_years_<?php echo $serial;?>', text: '<?php echo $division_sl.'. '.$division['division_name']?>', datafield: 'quantity_prediction_division_<?php echo $serial;?>_<?php echo $division['division_id']?>', width: 100, filterable: false, cellsalign: 'right',cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg,columntype: 'textbox',
                                ...
                                cellvaluechanging: function (row, datafield, columntype, oldvalue, newvalue)
                                {
                                    if (newvalue != oldvalue)
                                    {
                                        ...
                                        var sub_total=parseFloat(selectedRowData['quantity_prediction_sub_total_division_<?php echo $serial;?>'])-parseFloat(oldvalue)+parseFloat(newvalue);
                                        var outlet_total=parseFloat(selectedRowData['quantity_prediction_division_total'])-parseFloat(oldvalue)+parseFloat(newvalue);

                                        //console.log(selectedRowData);
                                        $("#system_jqx_container").jqxGrid('setcellvalue', row, 'quantity_prediction_sub_total_division_<?php echo $serial;?>', sub_total);
                                        $("#system_jqx_container").jqxGrid('setcellvalue', row, 'quantity_prediction_division_total', outlet_total);
                        ...
                        ?>
                        { columngroup: 'next_years_<?php echo $serial;?>', text: 'Total Target', dataField: 'quantity_prediction_sub_total_division_<?php echo $serial;?>',width:'100',filterable:false,cellsalign: 'right',editable:false,cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg},
                        <?php
                    }
                    ?>
                    { text: 'Total DI<br> Target', dataField: 'quantity_prediction_division_total',width:'100',filterable:false,align:'center',cellsalign: 'right',editable:false,cellsrenderer: cellsrenderer,aggregates: ['sum'],aggregatesrenderer:aggregatesrenderer_kg}
                ],
                columngroups:
                [
